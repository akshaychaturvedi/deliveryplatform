using {
    ...
    ey.ct.sap.ProvisionedTools as ProvisionedTools
} from '../db/data-model';
...
service DBService {
    ...
    entity ProvisionedToolsData as projection on ProvisionedTools;
    // Master Data
    ...
    entity ToolCatalog          as projection on Master.Tools;
    // Actions
    action UpdateEngagementDetails(engagementID : UUID)                                   returns String;
    action ConfirmPhase(engagementID : UUID)                                              returns String;
    action activateNextPhase(engagementID : UUID)                                         returns String;
    action updateProvisionedTool(engagementNumber : String, tool : String, link : String) returns String;
}
